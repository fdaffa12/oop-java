 ...
 * @author ASUS
 */
public class konversiKelvin extends javax.swing.JFrame {

    /**
     * Creates new form konversiKelvin
     */
    public konversiKelvin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APLIKASI KONVERSI KELVIN");

        jLabel2.setText("Masukan Nilai Kelvin = ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double fahrenheit = Double.parseDouble(kelvinField.getText()) * 1.8 - 459.67;
        fahrenheitField.setText(fahrenheit+ "");
        double celcius = Double.parseDouble(kelvinField.getText())- 273.15; 
        celciusField.setText(celcius+ "");
        double reamur = Double.parseDouble(kelvinField.getText())- 273.15 * 0.8;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(konversiKelvin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new konversiKelvin().setVisible(true);
            }
        });
    }
